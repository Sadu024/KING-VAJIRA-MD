...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'dark sadu' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Vajira' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? 'VAJIRA;;;ShareMission' : process.env.SESSION_ID,
